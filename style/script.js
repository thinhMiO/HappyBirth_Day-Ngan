...
const texts = [
  ...
  "🎂",
  "DEAR HÀ NGÂN",
  "03-11-2003", //Day of birth
  "HAPPY BIRTHDAY", 
  "ĐÀO HÀ NGÂN", //Your Name
  "Chúc Cho Ngân Luôn",
  "Hạnh Phúc ⭐",
  "May Mắn 🍀",
  "Thành Công",
  ...
  if (state === "forming") {
    ...
    if (now - explosionStartTime > EXPLOSION_TIME) {
      ...
      if (currentTextIndex >= texts.length) {
        showGiftBox(); // <-- Đảm bảo chỉ gọi ở đây!
        return;
      }
...
function showGiftBox() {
  ...
  if (giftBoxWrapper) giftBoxWrapper.style.display = 'block';
}

document.getElementById('giftBoxWrapper').addEventListener('click', function() {
  window.location.href = 'home.html'; // Đổi thành link bạn muốn
});
